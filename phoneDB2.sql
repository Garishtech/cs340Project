...
INSERT INTO `bsg_cert` VALUES (1,'Raptor'),(2,'Viper'),(3,'Mechanic'),
(4,'Command');
...
CREATE TABLE `bsg_cert_people` (
      ...
      PRIMARY KEY (`cid`,`pid`),
      KEY `pid` (`pid`),
      CONSTRAINT `bsg_cert_people_ibfk_1` FOREIGN KEY (`cid`) REFERENCES `bsg_cert`
    (`certification_id`),
      CONSTRAINT `bsg_cert_people_ibfk_2` FOREIGN KEY (`pid`) REFERENCES `bsg_people`
    (`character_id`)
...
CREATE TABLE `bsg_people` (
    ...
    (`planet_id`) ON DELETE SET NULL ON UPDATE CASCADE
...
INSERT INTO `bsg_people` VALUES (6,'Saul','Tigh',NULL,71,'Human'),
(9,'Callandra','Henderson',NULL,NULL,'Human'),(121,'harry','goober',18,23,'Human'),
(156,'','',1,0,'Human'),(157,'','',3,0,'Human'),(158,'The','Man',16,22,'Human');
...
INSERT INTO `bsg_planets` VALUES (1,'Gemenon',2800000000,'Old Gemenese','Oranu'),
(2,'Leonis',2600000000,'Leonese','Luminere'),
(3,'Caprica',4900000000,'Caprican','Caprica City'),
(7,'Sagittaron',1700000000,NULL,'Tawa'),(16,'Aquaria',25000,NULL,NULL),
(17,'Canceron',6700000000,NULL,'Hades'),(18,'Libran',2100000,NULL,NULL),
(19,'Picon',1400000000,NULL,'Queestown'),(20,'Scorpia',450000000,NULL,'Celeste'),
...
INSERT INTO `bsg_spaceship` VALUES (1,'t1','#',0),(2,'t2','#',0),(3,'t2','#',0),
(4,'t3','#',0),(5,'t4','\0',0),(6,'t5','#',0);
...
-- Dump completed on 2019-02-03  0:38:
